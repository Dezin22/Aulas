...
# INSERT INTO boxoffice (filme_id, rating, vendas_nacionais, vendas_internacionais) VALUES
...
# -- DELETE FROM filmes_disney;

# -- UPDATE  filmes_disney
# -- SET titulo = "O Rei Leão 3";



# -- 1 - SELECIONE  TODOS OS FILMES 
# SELECT * FROM filmes_disney;
# -- 2 - SELECIONE TODOS OS TITULOS DOS FILMES
# SELECT titulo FROM filmes_disney;
# -- - SELECIONE TODOS OS TITULOS E OS DIRETORES DOS FILMES
# SELECT titulo,diretor FROM filmes_disney;
# -- 5 - SELECIONE TODOS OS FILMES LANÇADOS ENTRE OS ANOS DE 2000 E 2010
# SELECT 
# 	* 
# FROM 
# 	filmes_disney 
...
# -- 6 - SELECIONE A MEDIA DE MINUTOS DE TODOS OS FILMES 
# SELECT 
# 	AVG(tamanho_minutos) 
# FROM filmes_disney;
# -- 7 - SELECIONE A SOMA TOTAL DE MINUTOS DOS FILMES
# SELECT 
# 	SUM(tamanho_minutos) 
# FROM filmes_disney;

# -- 8 - SELECIONE TODOS OS FILMES DO REI LEÃO
# SELECT 
# 	*
# FROM 
# 	filmes_disney
# WHERE 
# 	titulo LIKE "%O Rei %";
# -- DIFERENÇA DO LIKE PARA O = É QUE O LIKE VERIFICA SE HA AQUELA REFERENCIA NO REGISTRO 
# -- ENQUANTO O = VERIFICA SE AQUELA REFERENCIA É EXATAMENTE IGUAL AO REGISTRO


# -- 9 - SELECIONE A QUANTIDADE TOTAL DE FILMES
# SELECT
# 	COUNT(*)
# FROM 
# 	filmes_disney;
    
# -- 10 - SELECIONE TODOS OS FILMES MAIORES QUE 1 HORA E MEIA DE DURAÇÃO
...
# 	f.id = b.filme_id
# ORDER BY
# 	b.vendas_internacionais DESC LIMIT 3;
